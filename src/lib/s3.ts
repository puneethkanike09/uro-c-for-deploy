...
if (!process.env.AWS_ACCESS_KEY_ID || !process.env.AWS_SECRET_ACCESS_KEY) {
  console.error('S3: Missing AWS credentials! Please set AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY environment variables.');
}
...
export function generateFileKey(userId: string, fileName: string, fileType: string): string {
