            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <div className={`p-3 text-sm border rounded-md ${
                  error.includes('sent') ? 'text-green-500 bg-green-50 border-green-200' : 'text-red-500 bg-red-50 border-red-200'
                }`}>
                  {error}
                </div>
              )}
              <Button type="submit" className="w-full btn-primary" disabled={loading || otp.length !== 6}>
